            ...
            <div class="card">
                ...
                <div class="card-header flex-column flex-md-row">
                    <div class="head-label text-center">
                        <h5 class="card-title mb-0">Achievement List</h5>
                    </div>
                                    ...
                                    <td>
                                        <div class="d-inline-block">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end m-0" style="">
                                                ...
                                                <form action="{{ route('achievements.destroy', $value->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="dropdown-item text-danger delete-record">Delete</button>
                                                </form>
                                            </div>
                                        </div> | <a href="{{ route('achievements.edit', $value->id) }}" class="item-edit text-body"><i class="bx bxs-edit"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
