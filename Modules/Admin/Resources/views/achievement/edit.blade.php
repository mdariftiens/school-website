            ...
            <div class="card">
                ...
                <div class="card-header flex-column flex-md-row">
                    <div class="head-label text-center">
                        <h5 class="card-title mb-0">Achievement Update</h5>
                    </div>
                ...
                <div class="card mb-4">
                    <div class="card-body" style="box-shadow: none">
                        <form method="post" action="{{ route('achievements.update',$row->id) }}">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="mb-3">
                                <label class="form-label" for="english_title">English title <span>*</span></label>
                                <input type="text" class="form-control" name="english_title" id="english_title" placeholder="Bangla Name" value="{{ $row->english_title }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="bangla_title" id="bangla_title" placeholder="English Title" value="{{ $row->bangla_title }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" placeholder="English description" name="english_detail" rows="3">{{ $row->english_detail }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" placeholder="Bangla description" name="bangla_detail" rows="3">{{ $row->bangla_detail }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="date" name="published_date" value="{{ $row->published_date }}">
