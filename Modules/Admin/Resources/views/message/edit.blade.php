            ...
            <div class="card">
                ...
                <div class="card-header flex-column flex-md-row">
                    <div class="head-label text-center">
                        <h5 class="card-title mb-0">Message Update</h5>
                    </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" style="box-shadow: none">
                        <form method="post" action="{{ route('message.update', $row->id) }}">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder="English Designation" id="english_designation" name="english_designation"  value="{{ $row->english_designation }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="bangla_designation">Bangla Designation</label>
                                <input class="form-control" placeholder="Bangla Designation" name="bangla_designation" value="{{ $row->bangla_designation }}">
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="english_message">English Message</label>
                                <textarea class="form-control" placeholder="English Message" name="english_message" rows="3">{{ $row->english_message }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="bangla_message">Bangla Message</label>
                                <textarea class="form-control" placeholder="Bangla Message" name="bangla_message" rows="3">{{ $row->bangla_message }}</textarea>
                            </div>
