                        ...
                        @if($list)
                            <?php $i = 0; foreach($list as $value){ $i++; ?>
                                <tr>
                                    ...
                                    <td style="text-align: center">{{ $value->gallery_type }}</td>
                                    <td style="text-align: center">{{ $value->priority }}</td>
                                    <td style="text-align: center"><?= ($value->is_published == '1')? 'Yes' : 'No'?></td>
                                    <td>
                                        ...
                                        </div> | <a href="{{ route('gallery.edit', $value->id) }}" class="item-edit text-body"><i class="bx bxs-edit"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        @endif
