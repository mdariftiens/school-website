            ...
            <div class="card">
                ...
                <div class="card-header flex-column flex-md-row">
                    <div class="head-label text-center">
                        <h5 class="card-title mb-0">Employee List Create</h5>
                    </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" style="box-shadow: none">
                        <form method="post" action="{{ route('employee-list.store') }}">
                            {{ csrf_field() }}
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="english_name" placeholder="English name" value="{{ old('english_name') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="bangla_name" placeholder="Bangla name" value="{{ old('bangla_name') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="employee_identification_number" placeholder="Employee Identification Number" value="{{ old('employee_identification_number') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="contact_number" placeholder="Contact Number" id="contact_number" value="{{ old('contact_number') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="educational_qualification" placeholder="Educational Qualification" name="educational_qualification" rows="3" value="{{ old('educational_qualification') }}"></textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="email">Major Subject</label>
                                <input type="text" class="form-control" name="major_subject" id="major_subject" value="{{ old('major_subject') }}">
