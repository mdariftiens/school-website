...
@section('title', 'Management Committee - update')
@section('content')
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header flex-column flex-md-row">
                    <div class="head-label text-center">
                        <h5 class="card-title mb-0">Management Committee update</h5>
                    </div>
                ...
                <div class="card mb-4">
                    <div class="card-body" style="box-shadow: none">
                        <form method="post" action="{{ route('management-committee.update', $row->id) }}">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="mb-3">
                                <label class="form-label" for="english_name">English name <span>*</span></label>
                                <input type="text" class="form-control" name="english_name" id="english_name" placeholder="English Name" value="{{ $row->english_name }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="bangla_name" id="bangla_name" placeholder="Bangla Name" value="{{ $row->bangla_name }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="english_designation" id="english_designation" placeholder="English Designation" value="{{ $row->english_designation }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="bangla_designation" id="bangla_designation" placeholder="Bangla Designation" value="{{ $row->bangla_designation }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="contact_number" id="contact_number" placeholder="Contact Number" value="{{ $row->contact_number }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="priority" id="priority" placeholder="priority" value="{{ $row->priority }}">
