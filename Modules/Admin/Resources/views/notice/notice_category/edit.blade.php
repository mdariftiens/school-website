...
@section('title', 'Notice category - list')
            ...
            <div class="card">
                ...
                <div class="card-header flex-column flex-md-row">
                    <div class="head-label text-center">
                        <h5 class="card-title mb-0">Notice Category Update</h5>
                    </div>
                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                        <div class="dt-buttons">

                            <a class="dt-button create-new btn btn-info"
                               href="{{ route('notice-category.index') }}">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" style="box-shadow: none">
                        <form method="post" action="{{ route('notice-category.update', $category->id) }}">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="mb-3">
